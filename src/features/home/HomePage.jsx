...
// import BlogCard from '@/shared/components/BlogCard'
// import { blogPosts } from '@/shared/constants/blogs.data'
// import { photos, videos } from '@/shared/constants/Vedio.data' // Fixed duplicate import
// import LiveTicker from '../../layouts/LiveTicker'
// import Category from '../../layouts/Category.jsx'
// import Headline  from '../../layouts/Headline.jsx'
// import { cricketNewsData } from '@/shared/constants/cricketNews.data'
...
//   // Find the FA Cup article from footballNewsData
//   const faCupArticle = footballNewsData.find(article => article.id === 'fn-8')
  
//   const handleFACupClick = () => {
//     if (faCupArticle) {
//       // Navigate to football news detail page with the article's slug
//       navigate(`/football/news/${faCupArticle.slug}`)
//     } else {
//       // Fallback navigation if article not found
...
// const HeroSection = memo(() => (
//   /*
//     Layout (top → bottom, all in normal flow — no absolute positioning for heading):
//     1. LiveTicker  (relative z-10)
//     2. Category tabs  (rendered by <Category /> — assumed relative/sticky inside)
//     3. SportlyRadar heading + description  ← NEW, in-flow, centered
//     4. Headline  (relative z-10, pb-5)
//     Background image + dark overlay stay absolutely positioned behind everything.
//   */
//   <div className="relative text-white overflow-hidden" style={{ minHeight: '600px' }}>
//     {/* Background */}
//     <img
...
//     {/* 3. Heading + description — in normal flow, fully responsive */}
