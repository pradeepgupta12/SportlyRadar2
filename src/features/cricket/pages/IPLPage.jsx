...
// const IPLMatchCard = ({ match }) => (
//   <div className="bg-white dark:bg-[#1c2128] border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200 mb-3 sm:mb-4">
...
//           >
//             <span 
//               className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-bold flex-shrink-0 transition-transform group-hover:scale-105"
//               style={{ backgroundColor: match.team1.color || '#dc2626' }}
//             >
//               {match.team1.code}
//             </span>
//             <span className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base group-hover:text-[#00698c] dark:group-hover:text-[#00698c] transition-colors truncate">
//               {match.team1.name}
//             </span>
//           </Link>
//         </div>
...
//         <Link
//           to={`/cricket/ipl/match/${match.id}/teams`}
//           className="inline-flex items-center gap-1 text-xs sm:text-sm text-[#00698c] hover:text-[#0088b0] font-medium transition-colors"
//         >
//           View Match Details
...
//   // Handle scroll for sticky tabs effect
//   useEffect(() => {
//     const handleScroll = () => {
...
//     if (activeTab === 'Home') return iplMatches.slice(0, 3) // Show first 3 matches for home
//     return []
//   }
...
//         {/* IPL Sub-tabs - Responsive with horizontal scroll */}
//         <div className={`sticky top-0 z-10 bg-white dark:bg-[#1c2128] transition-shadow ${isScrolled ? 'shadow-md' : ''}`}>
//           <div className="relative">
//             <div className="flex items-center gap-0 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1c2128] rounded-t-lg overflow-x-auto scrollbar-hide">
//               {tabs.map((tab) => (
//                 <button
//                   key={tab}
//                   onClick={() => setActiveTab(tab)}
...
//           {/* Left: IPL content — narrowed to make room for right sidebar */}
